...
export default function Privacy() {
  ...
  return (
    <main>
      ...
      <div className="prose mx-auto max-w-6xl px-4 md:px-7">
        <div className=" md:px-8">
          Effective date: 04/27/2023<h2 className="text-3xl text-gray-900 dark:text-white">Introduction</h2>
          <p>
            Welcome to {window.location.hostname}, Inc. (“Company”, “we”, “our”, “us”)! As you have just
            clicked our Terms of Service, please pause, grab a cup of coffee and carefully read the following
          ...
          <p>
            ...
            https://{window.location.hostname} operated by {window.location.hostname}, Inc..
          </p>
          <p>
            Our Privacy Policy also governs your use of our Service and explains how we collect, safeguard and
            disclose information that results from your use of our web pages. Please read it here https://
            {window.location.hostname}/privacy.
          </p>
          <p>
          ...
          <p>
            ...
            please let us know by emailing at support@{window.location.hostname} so we can try to find a
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Communications</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Contests, Sweepstakes and Promotions</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Subscriptions</h2>
          <p>
          ...
          <p>
            ...
            conditions unless you cancel it or {window.location.hostname}, Inc. cancels it. You may cancel
            your Subscription renewal either through your online account management page or by contacting
            {window.location.hostname}, Inc. customer support team.
          </p>
          <p>
            A valid payment method, including credit card or PayPal, is required to process the payment for
            your subscription. You shall provide {window.location.hostname}, Inc. with accurate and complete
            billing information including full name, address, state, zip code, telephone number, and a valid
            payment method information. By submitting such payment information, you automatically authorize
            {window.location.hostname}, Inc. to charge all Subscription fees incurred through your account to
            any such payment instruments.
          </p>
          <p>
            Should automatic billing fail to occur for any reason, Meet Technologies Inc. will issue an
            electronic invoice indicating that you must proceed manually, within a certain deadline date, with
          ...
          <p>
            {window.location.hostname}, Inc. may, at its sole discretion, offer a Subscription with a free
          ...
          <p>
            ...
            by {window.location.hostname}, Inc. until Free Trial has expired. On the last day of Free Trial
          ...
          <p>
            At any time and without notice, {window.location.hostname}, Inc. reserves the right to (i) modify
            Terms of Service of Free Trial offer, or (ii) cancel such Free Trial offer.
          </p>
          <h2 className="text-3xl text-gray-900 dark:text-white">Fee Changes</h2>
          <p>
            {window.location.hostname}, Inc., in its sole discretion and at any time, may modify Subscription
            fees for the Subscriptions. Any Subscription fee change will become effective at the end of the
            then-current Billing Cycle.
          </p>
          <p>
            {window.location.hostname}, Inc. will provide you with a reasonable prior notice of any change in
          ...
          <p>
            {window.location.hostname}, Inc. has the right but not the obligation to monitor and edit all
            Content provided by users. In addition, Content found on or through this Service are the property
            of
            {window.location.hostname}, Inc. or used with permission. You may not distribute, modify,
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Prohibited Uses</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">No Use By Minors</h2>
          <p>
          ...
          <p>
            ...
            other than you, without appropriate authorization. You may not use as a username any name that is
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Intellectual Property</h2>
          <p>
            Service and its original content (excluding Content provided by users), features and functionality
            are and will remain the exclusive property of {window.location.hostname}, Inc. and its licensors.
            Service is protected by copyright, trademark, and other laws of foreign countries. Our trademarks
            and trade dress may not be used in connection with any product or service without the prior
            written consent of {window.location.hostname}, Inc..
          </p>
          <h2 className="text-3xl text-gray-900 dark:text-white">Copyright Policy</h2>
          <p>
          ...
          <p>
            ...
            via email to dmca@{window.location.hostname}, with the subject line: “Copyright Infringement” and
          ...
          <p>You can contact our Copyright Agent via email at dmca@{window.location.hostname}</p>
          <h2 className="text-3xl text-gray-900 dark:text-white">Error Reporting &amp; Feedback</h2>
          <p>
            You may provide us either directly at support@{window.location.hostname} or via third party sites
            and tools with information and feedback concerning errors, suggestions for improvements, ideas,
          ...
          <p>
            aygun is automated error monitoring software provided by Raygun Limited. Privacy Policy is
            accessible at https://raygun.com/privacy/
          </p>
          <h2 className="text-3xl text-gray-900 dark:text-white">Links To Other Web Sites</h2>
          <p>
            Our Service may contain links to third party web sites or services that are not owned or
            controlled by Meet Technologies Inc..
          </p>
          <p>
            {window.location.hostname}, Inc. has no control over, and assumes no responsibility for the
          ...
          <p>
            YOU ACKNOWLEDGE AND AGREE THAT CALENDSO LTD SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Disclaimer of Warranty</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Termination</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Governing Law</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Changes To Service</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Amendments To Terms</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Waiver And Severability</h2>
          <p>
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Acknowledgement</h2>
          <p>
          ...
          <p>By email: support@{window.location.hostname}.</p>
        </div>
      </div>
    </main>
  );

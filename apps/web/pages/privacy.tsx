    ...
    <main>
      ...
      <div className="prose mx-auto max-w-6xl px-4 md:px-7">
        <div className="md:px-8">
          ...
          <p>Welcome to {window.location.hostname}.</p>
          <p>
            {window.location.hostname} (“us”, “we”, or “our”) operates https://{window.location.hostname}{" "}
            (hereinafter referred to as “Service”).
          </p>
          <p>
            Our Privacy Policy governs your visit to https://{window.location.hostname}, and explains how we
          ...
          <p>
            SERVICE means the https://{window.location.hostname} website operated by{" "}
          ...
          <p>
            ...
            these communications from us by following the unsubscribe link or by emailing at support@
            {window.location.hostname}.
          </p>
          <p>
          ...
          <p>{window.location.hostname} uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            {window.location.hostname} will take all the steps reasonably necessary to ensure that your data
          ...
          <p>
            ...
            from our systems, please email us at support@{window.location.hostname}.
          </p>
          ...
          <ul>
            ...
            <li>
              users are able to change their personal information by emailing us at support@
              {window.location.hostname}.
            </li>
          </ul>
          ...
          <p>
            ...
            <br />
            Privacy-focused website analytics from a sustainable company. A GDPR compliant, Google Analytics
            alternative.
          </p>
          <p>
            For more information on the privacy practices of Fathom, please visit the Fathom Privacy Terms web
            page: https://usefathom.com/terms
          </p>
